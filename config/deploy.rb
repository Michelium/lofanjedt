...
set :application, 'lofanjedt'
set :repo_url, 'git@github.com:Michelium/lofanjedt.git'
...
#         execute "cd #{release_path} && php bin/console assets:install"
        execute "cd #{release_path} && php bin/console doctrine:migrations:migrate --no-interaction"
        execute "cd #{release_path} && php bin/console cache:clear"
    end
  end
